                        ...
                        <SocialMediaItem>
                            <SocialMediaBox height={100} isActive={over === "social-media"}>
                                <SocialMediaLabel
                                    ...
                                    <LabelAnchor target="_blank" href="https://t.me/space21io">Telegram</LabelAnchor>
                                    <LabelAnchor target="_blank" href="https://www.instagram.com/space21.io">Instagram</LabelAnchor>
                                    <LabelAnchor target="_blank" href="https://www.facebook.com/Space21io-103244022032947/">Facebook</LabelAnchor>
                                </SocialMediaLabel>
                            </SocialMediaBox>
                            ...
                            <WebsiteItem portfolio={pathName === '/services'} className={"visit-card-website"}>
                                <WebsiteBox isActive={over === "website"}>
                                    <WebsiteLabel portfolio={pathName === '/services'} className={"visit-card-website-label"}
                                        ...
                                        <LabelAnchor href="https://space21.io/">website</LabelAnchor>
                                    </WebsiteLabel>
                                </WebsiteBox>
                                <CompanyNameItem>
                                    <CompanyNameBox
                                        ...
                                        <CompanyNameLabel portfolio={pathName === '/services'}
                                            ...
                                            <LabelAnchor href="https://space21.io/">company name</LabelAnchor>
                                        </CompanyNameLabel>
                                    </CompanyNameBox>
                                    <CompanyNameText
                                        portfolio={pathName === '/services'}
